...
assert.match(styles, /\.ask-ai-panel\.expanded[\s\S]*--ask-ai-workspace-inset: 16px;[\s\S]*--ask-ai-workspace-sidebar-width: calc\(var\(--sidebar\) - var\(--ask-ai-workspace-inset\) - 1px\);[\s\S]*--ask-ai-workspace-header-height: 96px;[\s\S]*inset: var\(--ask-ai-workspace-inset\);[\s\S]*width: auto;/, "Ask AI expanded mode should align the chat history sidebar to the app sidebar divider and share header height.");
...
assert.match(styles, /\.ask-ai-workspace-header\s*\{[\s\S]*min-height: var\(--ask-ai-workspace-header-height\);[\s\S]*height: var\(--ask-ai-workspace-header-height\);[\s\S]*align-items: center;[\s\S]*border-bottom: 1px solid var\(--line\)/, "Ask AI main header should align to the same divider row as the sidebar.");
